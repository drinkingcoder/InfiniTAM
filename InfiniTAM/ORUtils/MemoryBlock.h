...
//		*/
//		MemoryManager(size_t dataSize, bool allocate_CPU, bool allocate_CUDA, bool metalCompatible = true)
//		{
...
//		is enabled.
//		*/
//		MemoryManager(size_t dataSize, MemoryDeviceType memoryType)
//		{
//			this->isAllocated_CPU = false;
//			this->isAllocated_CUDA = false;
//			this->isMetalCompatible = false;
...
//
//		/** Copy data */
//		void SetFrom(const MemoryManager<T> *source, MemoryCopyDirection memoryCopyDirection)
//		{
...
//		}
//
//		virtual ~MemoryManager() { this->Free(); }
//
